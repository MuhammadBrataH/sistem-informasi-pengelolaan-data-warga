...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2><i class="bi bi-plus-square"></i> Tambah Kartu Keluarga</h2>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="bi bi-file-earmark-plus"></i> Form Kartu Keluarga Baru</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('kartu-keluarga.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kepala_keluarga') is-invalid @enderror" 
                               id="kepala_keluarga" name="kepala_keluarga" value="{{ old('kepala_keluarga') }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                  ...
                                  placeholder="Masukkan alamat lengkap (nama jalan, nomor rumah, dll)" required>{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('rw') is-invalid @enderror" 
                                   id="rw" name="rw" value="{{ old('rw', '04') }}" readonly>
                            @error('rw')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
